...
insert into recipe (title, ingredients, description, author, status, created_at, updated_at) values ('Cake with cocoa-cream', '6 eggs, 6 heaps of sugar,6 heaps of flour,Lemon peel obtained from 0.25 lemon,2 tbsp sugar, 1 pack of vanilla sugar, 5 gl milk, 20 dkg butter, 20 dkg powdered sugar, 2 tbsp unsweetened cocoa powder', 'description1', 'Admin', 'ADMIN', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into recipe (title, ingredients, description, author, status, created_at, updated_at) values ('pulled pork', 'hozzavalok1', 'description2', 'Admin', 'ADMIN', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into recipe (title, ingredients, description, author, status, created_at, updated_at) values ('soup1', 'hozzavalok1', 'description3', 'Admin', 'ADMIN', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into recipe (title, ingredients, description, author, status, created_at, updated_at) values ('beef1 mince', 'hozzavalok1', 'description4', 'Admin', 'ADMIN', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
